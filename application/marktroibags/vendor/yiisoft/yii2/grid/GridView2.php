...
/**
 * The GridView2 widget is used to display data in a grid.
 *
 ...
 * @since 2.0
 */
class GridView2 extends BaseListView
{
    ...
    public function run()
    {
        ...
        $view = $this->getView();
        GridView2Asset::register($view);
        $view->registerJs("jQuery('#$id').yiiGridView2($options);");
        parent::run();
    }
